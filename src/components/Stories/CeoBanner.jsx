...
const CeoBanner = () => {
  return (
    <div className="flex flex-col justify-between gradient-lr w-full rounded-lg p-4 text-white text-center text-3xl relative gap-14 max-md:flex-col">
      <div
        className="grow font-semibold flex flex-col capitalize"
