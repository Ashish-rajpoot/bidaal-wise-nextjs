...
const Stories = () => {
  return (
    <div className="h-fit bg-section2 ">
      <div className=" flex justify-between py-20 items-center  flex-col space-y-10 mx-auto px-5">
        ...
        <CeoBanner />
        <p className="text-darkGreen text-[1.5rem] font-bold flex flex-col justify-center items-center">
