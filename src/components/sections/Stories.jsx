...
const Stories = () => {
  return (
    <div className="h-fit bg-section2 ">
      <div className=" flex justify-between py-5 max-md:py-10 items-center  flex-col space-y-10 mx-auto px-5 lg-device">
        <h1 className="text-6xl max-md:text-3xl font-semibold text-center py-14"> How our customers have benefited</h1>
        ...
        <CeoBanner />
        <p className="text-darkGreen text-2xl font-bold flex flex-col justify-center items-center max-md:text-center py-20 max-md:10">
