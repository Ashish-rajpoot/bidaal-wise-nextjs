...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className=" relative z-10 flex flex-col  justify-center md:justify-end md:pb-40 text-textWhite w-screen min-h-screen gap-y-6 -mt-16 mob-def-pad gap-11">
