...
const Section2 = () => {
  return (
    <div className="flex justify-center items-center flex-col text-textWhite py-20 ">
      ...
      <div className="gradient-tb mt-20 text-[1.5rem] font-semibold w-screen h-[400px] flex justify-evenly items-center max-md:flex-col ">
